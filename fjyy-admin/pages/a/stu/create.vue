                ...
                <div class="table-wrapper">
                    ...
                    <el-form ref="stuForm" :model="stuForm" :rules="rules" label-width="140px">
                        ...
                        <el-form-item label="出生日期" prop="birthday">
                            <el-date-picker value-format="yyyy-MM-dd" type="datetime" placeholder="请选择出生日期"
                                v-model="stuForm.birthday" style="width: 360px;"></el-date-picker>
                        </el-form-item>
...
module.exports = {
    ...
    mounted() {  //Vue 生命周期钩子，当页面挂载完成后，自动执行 initStuList() 方法，初始化学生列表。
        var me = this;
